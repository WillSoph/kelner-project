                ...
                <Listbox.Label className="block text-sm font-medium leading-6 text-gray-900">{props.texto}</Listbox.Label>
                    <div className="relative mt-2">
                        ...
                        <span className="flex items-center">
                            <img width={20} height={20} src={selected.avatar} alt="" className="h-5 w-5 flex-shrink-0 rounded-full" />
                        ...
                        <Listbox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                            ...
                            >
                                ...
                                <>
                                    ...
                                    <img width={20} height={20} src={person.avatar} alt="" className="h-5 w-5 flex-shrink-0 rounded-full" />
                                    <span
